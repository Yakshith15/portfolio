...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 sticky top-0 w-full h-20 flex items-center justify-between px-4 max-w-full mx-auto z-50 transition-all duration-300 shadow-md">
